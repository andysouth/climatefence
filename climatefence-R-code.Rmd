...
```{r data-reading, include=TRUE, warning=FALSE, message=FALSE}
...
```{r data-averaging, include=TRUE, warning=FALSE, message=FALSE}
...
Starting to plot yearly coloured stripes using [code borrowed from Dominic Roye](https://dominicroye.github.io/en/2018/how-to-create-warming-stripes-in-r/). Thanks Dominic !
